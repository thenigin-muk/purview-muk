...
\[Placeholder: This is where example images will be added to show how filtering and sorting works in SharePoint.\]
...
"citation": {"name": schedule.get("scheduleName", "CORE (Local Government Common Records Retention Schedule)"), "url": "<https://www.sos.wa.gov/archives/recordsmanagement/local-government-records-retention-schedules---alphabetical-list.aspx"}>
